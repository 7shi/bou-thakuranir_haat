...
[all/captions.jsonl](all/captions.jsonl) | per-segment captions in Bengali, Hindi, English and Japanese by Gemini 2.5 Pro, a matched set per segment (the segment headings on the chapter pages)
...
[images.md](images.md) | Image generation prompts for illustrations (generated images are distributed separately via [Releases](https://github.com/7shi/bou-thakuranir_haat/releases))
