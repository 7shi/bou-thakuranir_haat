...
| :--- | :--- | :--- | :--- |
| **動詞の活用** | হইয়াছে (`hoiyache`) | **হয়েছে** (`hoyeche`) | 〜になった |
| **動詞の活用** | হইয়া গিয়াছে (`hoiya giyache`) | **হয়ে গেছে** (`hoye geche`) | 〜になってしまった |
| **動詞の活用** | নড়িতেছে (`noṛiteche`) | **নড়ছে** (`noṛche`) | 動いている |
| **代名詞** | তাঁহার (`tãhar`) | **তাঁর** (`tãr`) | 彼の/彼女の |
| **語彙 (名詞)** | শয়ন-গৃহ (`śoyon-griho`) | **শোবার ঘর** (`śobar ghor`) | 寝室 |
...
| :--- | :--- | :--- | :--- |
| **月** | **চন্দ্র (Condro)** | **चंद्र (Chandra)** | **চাঁদ (Cãd)** |
